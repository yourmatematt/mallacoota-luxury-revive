...
const ABOUT_SCHEMA = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      "description":
        "Meet the team behind Hammond Properties - local Mallacoota experts providing exceptional holiday rental experiences.",
      "mainEntity": {
        "@type": "LocalBusiness",
        "@id": "https://hammondproperties.com.au/#localbusiness",
      },
...
const About = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOMetaTags
        title="About Hammond Properties | Local Mallacoota Holiday Rental Experts"
        description="Meet Amelia & Terry — Mallacoota vacation rental experts with 40+ years experience, 1,000+ guests served. Local hospitality experts."
        canonical="https://hammondproperties.com.au/about"
        ogImage="https://hammondproperties.com.au/images/about-hero-background.jpg"
        imageAlt="Amelia Hammond and Terry Pheeney - Hammond Properties owners"
        schema={ABOUT_SCHEMA}
      />
      <Header />
